...
export default {
	...
	methods: {
		onInputImage(e) {
			...
			// this.url1 = URL.createObjectURL(this.$refs.postImage.files[0]);
			// this.url2 = URL.createObjectURL(this.$refs.postImage.files[1]);
			// this.url3 = URL.createObjectURL(this.$refs.postImage.files[2]);
			this.previewURL(e);
		},
		previewURL(e) {
			let url1;
